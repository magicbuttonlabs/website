...
**Open — follow-up the dropdown surfaced:**
- **Footer Solutions column vs the dropdown disagree.** The dropdown lists 5 (includes Custom Work & Managed Services); the footer Solutions column still lists only the 4 productized offerings. Decide whether to add Custom Work to the footer too (same ~23-page chrome sweep) so nav + footer agree. Recommended: add it, for consistency.
**Parked — later / v2:**
