...
- **`solutions.html` "two paths to win"** — simplify the Solutions hub to two clear paths, with the detailed three-level breakdown (Foundation / CJ / Custom + Managed) living there. This is where Corrine's "make it much simpler" now lands — NOT the homepage.
